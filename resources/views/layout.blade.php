                ...
                <div class="navigation">
                    <span class="menu"></span> 
                        <ul class="navig">
                            ...
                            <li><a href="{{route('danh-muc.show', ['id'=>$cate->id , 'str'=>Str::slug($cate->title)] ) }}">{{$cate->title}}</a></li>
                            @endforeach
        ...
        <div class="footer">
            <div class="container">
                <div class="footer-text">
                    <p>© 2022 Coffee Break. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">Me</a> </p>
                </div>
            </div>
        </div>
        <!--footer-end-->
